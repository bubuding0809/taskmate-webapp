  ...
  return (
    <>
      ...
      <div className=" max-w-auto flex min-h-screen items-center justify-center bg-gradient-to-r from-cyan-500 to-blue-500">
        <img className="rounded-l-2xl shadow-lg" src="/bg-login.jpg" />
        <div className="flex w-auto space-y-7 overflow-hidden rounded-r-2xl  bg-gray-300/75 px-6 py-12 shadow-lg">
          <div>
