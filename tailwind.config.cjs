...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        "solid-sm": "3px 3px 0.5px #94a3b8",
        "solid-md": "4px 4px 0.5px #94a3b8",
        "solid-lg": "5px 5px 0.5px #94a3b8",
        "solid-xl": "6px 6px 0.5px #94a3b8",
        "solid-2xl": "7px 7px 0.5px #94a3b8",
        "solid-3xl": "8px 8px 0.5px #94a3b8",
        "solid-4xl": "9px 9px 0.5px #94a3b8",
        "solid-5xl": "10px 10px 0.5px #94a3b8",
        "solid-6xl": "11px 11px 0.5px #94a3b8",
      },
      animation: {
        fade: "fade 5s ",
      },
